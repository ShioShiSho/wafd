...
difficulty peaceful
effect give @a instant_health 3 3 false
...
execute positioned -9 116 0 if score Active_players Lobby matches ..15 as @p[x=-9, dx=0.5, y=116, dy=2, z=0, dz=1, gamemode=adventure] run function wafd:lobby/accept_player

execute positioned -9 116 0 if score Active_players Lobby matches 16 as @p[x=-8, dx=0.5, y=116, dy=2, z=0, dz=1, gamemode=adventure] run function wafd:lobby/reject_player
